<template>
  <div class="index-wrap">
      ...
      <div class="index-right">
        <!-- 子组件发送了$emit,父组件就能监听子组件的变化，@onchange="doSomethingOnSlideChange" -->
...
export default {
  ...
  created() { //created是生命周期函数,在实例创建完成后被立即调用
  ...
  methods: {
    doSomethingOnSlideChange() {
      console.log('doSomethingOnSlideChange run!');//这样就可以写子组件发生变化时的函数了。
    }
  },
  data() {
      return {
